...
both" — that is exactly the two peers above, `claude-code` and `antigravity`, and not yourself.
...
third member, `"codex:<model>"`, and read its caveat like any other. Send **one** `targets` call
